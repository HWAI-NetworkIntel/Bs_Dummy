        ...
        >
          ...
          >
            ...
            <Input
              ...
              // }}
              placeholder={removeSymbolsFromInput(benefits[selectedBidId][singleDataItem.benefitOrder].currentValue)}
            ...
            //   } else {
            //     if (
            //       removeSymbolsFromInput(benefits[selectedBidId][renderingList[renderingItem][1]?.benefitOrder].currentValue) === '0' &&
            //       removeSymbolsFromInput(benefits[selectedBidId][renderingList[renderingItem][0]?.benefitOrder].currentValue) === '0'
            //     ) {
            //     } else if (
            //       removeSymbolsFromInput(benefits[selectedBidId][renderingList[renderingItem][1]?.benefitOrder].currentValue) === '' &&
            //       removeSymbolsFromInput(benefits[selectedBidId][renderingList[renderingItem][0]?.benefitOrder].currentValue) === ''
            //     ) {
            //     } else if (
            //       benefits[selectedBidId][renderingList[renderingItem][1]?.benefitOrder].currentValue === 'NC' &&
            //       benefits[selectedBidId][renderingList[renderingItem][0]?.benefitOrder].currentValue === 'NC'
            //     ) {
