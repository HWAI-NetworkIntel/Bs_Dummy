    ...
    if (previousValueIsPresentAs) {
      ...
      Object.keys(renderingList).length > 0 &&
        Object.keys(renderingList).forEach((el) => {
          if (
            benefits[selectedBidId][renderingList[el][0].benefitOrder].newValue !==
            benefits[selectedBidId][renderingList[el][0].benefitOrder].currentValue
          ) {
            setAllInputs((prev) => ({
              ...prev,
              [el]: {
                0: removeSymbolsFromInput(benefits[selectedBidId][renderingList[el][0].benefitOrder].newValue),
                1: removeSymbolsFromInput(benefits[selectedBidId][renderingList[el][1].benefitOrder].newValue),
              },
            }))
          }
        })
        ...
        <div className="flex gap-x-4">
          {Object.keys(renderingList)?.map((renderingItem, ii) => (
            <div key={ii} className="flex flex-col items-center gap-y-4 w-56">
              <Radio value={renderingItem}> {renderingItem} </Radio>
                        ...
                        >
                          ...
                          >
                            ...
                            <Input
                              ...
                              placeholder={removeSymbolsFromInput(singleDataItem.newValue)}
